...
/*  Name(s): Alex Campero, Diana Flores Valdivia
 * Netid(s): adc246, df367
 * What I thought about this assignment:
 * This one took longer than expected, so I wish I started earlier, but overall
 * I'd say it was pretty manageable.
 *
 */
...
public class DLList<E> {
    ...
    public void append(E v) {
        ...
        if (tail != null && head != null) {
            Node bruh= new Node(tail, v, null);
            tail.next= bruh;
            tail= bruh;

        } else {
            Node bruh= new Node(head, v, head);
            head= bruh;
            tail= bruh;
    ...
    public void prepend(E v) {
        ...
        if (tail != null && head != null) {
            Node bruh= new Node(null, v, head);
            head.prev= bruh;
            head= bruh;
